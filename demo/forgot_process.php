...
$query = "SELECT * from  member where ( email = '$login')"; 
$res = mysqli_query($dbc,$query);
$count=mysqli_num_rows($res);
//echo $count;
if($count==1)
{
$findresult = mysqli_query($dbc, "SELECT * FROM member WHERE ( email = '$login')");
...
$ReplyTo="kanishamokal435@gmail.com";
...
$headers  = "MIME-Version: 1.0\n";
     ...
     $msg="Your password reset link <br> http://localhost/demo/password-reset.php?token=".$token." <br> Reset your password with this link .Click or open in new tab<br><br> <br> <br> <center>".$credits."</center>"; 
